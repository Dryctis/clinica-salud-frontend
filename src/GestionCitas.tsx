...
    // Encontrar el paciente seleccionado para obtener su nombre y apellido
    const selectedPatient = patients.find(p => p.id === patientId);
    if (!selectedPatient) {
      setError('Paciente no encontrado. Por favor, selecciona un paciente de la lista.');
      setLoading(false);
      return;
    }
...
    // El backend espera 'nombre' y 'apellido', por lo que los extraemos del paciente.
    const dataToSend = {
      patientId,
